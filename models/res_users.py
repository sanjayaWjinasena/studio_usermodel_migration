...
class ResUsers(models.Model):
    ...
    # v0.0.N: 47 res.users Studio fields as plain storage.
    # CDB has these with related=partner_id.X but source fields do not
    # exist on res.partner. Odoo 17 rejects broken related paths, so
    # ship as plain fields. Columns created by _auto_init on upgrade.
    # See feedback-related-field-source-ordering memory.
