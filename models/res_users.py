...
class ResUsers(models.Model):
    ...
    x_studio_mandatory_bank_gu = fields.Boolean(string='Mandatory Bank Gu', readonly=True)
    ...
    x_studio_payment_term = fields.Many2one('account.payment.term', string='Payment Term-Delete', readonly=True)
    x_studio_related_field_49eDN = fields.Boolean(string='New Related Field', readonly=True)
    x_studio_related_field_TZMCl = fields.Char(string='New Related Field', readonly=True)
    x_studio_related_field_Uojrf = fields.Char(string='New Related Field', readonly=True)
    x_studio_related_field_UwEX1 = fields.Char(string='New Related Field', readonly=True)
    x_studio_related_field_YVuN0 = fields.Char(string='New Related Field', readonly=True)
    x_studio_related_field_j3X4Q = fields.Many2one('account.payment.term', string='New Related Field', readonly=True)
    x_studio_related_field_ngmve = fields.Many2one('account.payment.term', string='New Related Field', readonly=True)
    x_studio_related_field_pEksg = fields.Selection(selection=[], string='New Related Field', readonly=True)
    x_studio_related_field_tLbBY = fields.Many2one('account.payment.term', string='New Related Field', readonly=True)
    x_studio_related_field_xfyUN = fields.Char(string='New Related Field', readonly=True)
    ...
    x_studio_terms_of_payment = fields.Many2one('account.payment.term', string='Terms of Payment', readonly=True)
