...
class ResUsers(models.Model):
    ...
    # v0.0.43: 47 res.users x_studio_ fields (Fields-gap closure).
    # Columns provisioned by migrations/17.0.1.0.43/pre-migrate.py
    # BEFORE registry setup. Do not add related= — CDB has broken
    # related=partner_id.X paths where source fields do not exist
    # on res.partner. See feedback-related-field-source-ordering memory.
    x_studio_binary_field_0lxfw = fields.Binary(string='New File')
    x_studio_binary_field_0lxfw_filename = fields.Char(string='Filename for x_studio_binary_field_0lxfw')
    x_studio_binary_field_6Qgy3 = fields.Binary(string='New File')
    x_studio_binary_field_6Qgy3_filename = fields.Char(string='Filename for x_studio_binary_field_6Qgy3')
    x_studio_boolean_field_5hcBi = fields.Boolean(string='New Checkbox')
    x_studio_boolean_field_IhZPZ = fields.Boolean(string='New Checkbox')
    x_studio_boolean_field_iWSSd = fields.Boolean(string='New Checkbox')
    x_studio_char_field_169HD = fields.Char(string='New Text')
    x_studio_char_field_vHXsn = fields.Char(string='New Text')
    x_studio_char_field_zMp65 = fields.Char(string='New Text')
    ...
    x_studio_many2one_field_qX4FU = fields.Many2one('x_vendor_group', string='Vendor Group')
    x_studio_payment_term = fields.Many2one('account.payment.term', string='Payment Term-Delete')
    x_studio_related_field_49eDN = fields.Boolean(string='New Related Field')
    x_studio_related_field_TZMCl = fields.Char(string='New Related Field')
    x_studio_related_field_Uojrf = fields.Char(string='New Related Field')
    x_studio_related_field_UwEX1 = fields.Char(string='New Related Field')
    x_studio_related_field_YVuN0 = fields.Char(string='New Related Field')
    x_studio_related_field_j3X4Q = fields.Many2one('account.payment.term', string='New Related Field')
    x_studio_related_field_ngmve = fields.Many2one('account.payment.term', string='New Related Field')
    x_studio_related_field_pEksg = fields.Selection(selection=[], string='New Related Field')
    x_studio_related_field_tLbBY = fields.Many2one('account.payment.term', string='New Related Field')
    x_studio_related_field_xfyUN = fields.Char(string='New Related Field')
    x_studio_sdfsdf = fields.Date(string='X Studio Sdfsdf')
    x_studio_selection_field_3FlOG = fields.Selection(selection=[], string='New Selection')
    x_studio_selection_field_VAQjO = fields.Selection(selection=[], string='New Selection')
    x_studio_selection_field_lm0NR = fields.Selection(selection=[], string='New Selection')
    x_studio_selection_field_sDxoe = fields.Selection(selection=[], string='New Selection')
    x_studio_terms_of_payment = fields.Many2one('account.payment.term', string='Terms of Payment')
    x_studio_vendor_group1 = fields.Many2one('x_vendor_group', string='Vendor Group1')
